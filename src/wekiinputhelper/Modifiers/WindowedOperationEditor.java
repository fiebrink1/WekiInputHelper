...
public class WindowedOperationEditor extends InputModifierBuilderPanel {
     ...
     */
    public WindowedOperationEditor() {
        initComponents();
        w = null;
        op = null;
        setDimensionality(1);
    ...
    public WindowedOperationEditor(WekiInputHelper w, Operation op) {
        initComponents();
        this.w = w;
        this.op = op;
    ...
    private void comboFeatureNamesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboFeatureNamesActionPerformed
        updateName();
        //labelName.setText("Name: " + WindowedAverage.makeName(w.getInputManager().getInputNames()[comboFeatureNames.getSelectedIndex()]));
    ...
    public boolean validateForm() {
        try {
            ...
            if (i >= 1) {
              ...
              Util.showPrettyErrorPane(this, "Window size must be at least 1");
                return false;  
            }
        } catch (NumberFormatException ex) {
            Util.showPrettyErrorPane(this, "Window size must be at least 1");
